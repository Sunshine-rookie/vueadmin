  ...
  <div class="wdgl">
    ...
    <div class="section" style="margin-top:6px;border: 1px solid rgba(204, 204, 204, 1);">
      <div class="query">
        ...
        <div class="info" style="height:50px;line-height:50px;">
          <el-form :label-position="labelPosition" label-width="80px" >
            <el-form-item label="省份" id="province" >
              <select v-model="prov" placeholder="请选择省份">
                <option v-for="option in arr" :value="option.name">
                    {{ option.name }}
                </option>
              </select>
            </el-form-item>
            <el-form-item label="城市" id="city">
              <select v-model="city">
            ...
            <el-form-item label="区 / 县" id="districtAndCounty" >
...
<script>
  var arrAll =[
              {name: "请选择省份", sub: [{name: "请选择城市"}], type: 1,},
              {
                  name: "北京",
                  sub: [
                      {name: "请选择", sub: []},
